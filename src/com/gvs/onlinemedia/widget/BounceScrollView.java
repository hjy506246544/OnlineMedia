...
public class BounceScrollView extends ScrollView {
	...
	// inner澶撮儴涓巗crollview椤堕儴鐨勫師濮嬭窛锟�?
	private int originHeaderPadding;
	// inner灏鹃儴涓巗crollview搴曢儴鐨勫師濮嬭窛锟�?
	private int originFooterPadding;

	// inner澶撮儴涓巗crollview椤堕儴鐨勮窛锟�?
	private int headerOffset;
	// inner灏鹃儴涓巗crollview搴曢儴鐨勮窛锟�?
	...
	public boolean commOnTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			// 涓洪槻姝㈡姈鍔紝姣忔涓婃媺鎴栵拷?涓嬫媺鏃剁粰瀹氫竴涓垵濮嬶拷?锛屼负1
			...
			// 鍒ゆ柇涓婃媺杩樻槸涓嬫媺
			// 涓婃媺鏃讹紝椤堕儴offset蹇呴』锟�?锛屽惁鍒欎細閲嶇疆锛屽弽涔嬩害锟�?
